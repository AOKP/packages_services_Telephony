...
public class CallNotifier extends Handler
    ...
    private static final int VIBRATE_60_SEC = 28;
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case VIBRATE_60_SEC:
                vibrate(70, 0, 0);
                sendEmptyMessageDelayed(VIBRATE_60_SEC, 60000);
                break;
    ...
    private void onPhoneStateChanged(AsyncResult r) {
        ...
        if (c != null && !c.isIncoming() && c.getState() == Call.State.ACTIVE) {
            ...
            if (vib60) {
                ...
                start60SecondVibration(callDurationMsec);
            }
        }
    ...
    private void onDisconnect(AsyncResult r) {
        ...
        // Stop 60-second vibration
        removeMessages(VIBRATE_60_SEC);
    ...
    private void start60SecondVibration(long callDurationMsec) {
